...
import SectionShri from './sections/Shri';
import SectionAsharq from './sections/AsharqCar';
...
export default function Work() {
  ...
  return (
    <div className="row row-title h-[230vh] z-0 text-white" style={{ justifyContent: 'left' }}>
      ...
      <div 
        ref={(el: HTMLDivElement | null) => { projectRefs.current[4] = el }}
        className="col border-y-2 hover:text-[#399918] cursor-pointer border-white py-10"
        onClick={() => handleProjectClick(4)}
      >
        <h2 className="flex items-center justify-between">
          <AnimatedText text="SHRI MICROSERVICES :" />
          <div className="flex items-center gap-2">
          <span className="text-[20px] md:text-[30px] text-red-600 font-[AtomicMarker] mr-1">2025</span>
          <IoIosArrowDropdown className="text-2xl md:text-3xl text-gray-100 mr-4" />
          </div>
      ...
      <div 
        ref={(el: HTMLDivElement | null) => { projectRefs.current[5] = el }}
        className="col border-y-2 hover:text-[#399918] cursor-pointer border-white py-10"
        onClick={() => handleProjectClick(5)}
      >
        <h2 className="flex items-center justify-between">
          <AnimatedText text="ASHARQ Al Awsat Car :" />
          <div className="flex items-center gap-2">
          <span className="text-[20px] md:text-[30px] text-red-600 font-[AtomicMarker] mr-1">2025</span>
          <IoIosArrowDropdown className="text-2xl md:text-3xl text-gray-100 mr-4" />
          </div>
