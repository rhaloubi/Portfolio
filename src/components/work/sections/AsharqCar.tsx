...
export default function AsharqCar() {
        ...
        <div className="flex flex-col font-[SFCompactRounded] md:flex-row gap-8">
            <div className="flex-1 p-4 text-center">
                ...
                <p className="text-gray-100 mb-6 px-8 text-lg">
                    Asharq Al Awsat Car is a complete car rental platform built with Next.js, PostgreSQL, and Cloudinary. 
                    It enables users to browse vehicles, view details, and book cars seamlessly. 
                    The platform is fully optimized for SEO and features responsive design, dynamic car listings, and image management through Cloudinary.
                </p>
                <Button 
                    ...
                    onClick={() => router.push('/projects/AsharqCar')}
                >
                    Check Project
                </Button>
            </div>
                ...
                <div className="w-full md:w-[35vw]">
                    <div className="flex justify-center font-[TTTrailers] text-gray-300 items-center gap-4 my-4">
                        <div className="bg-green-900 px-1">
                            <h3 className="text-3xl text-center">NextJS</h3>
                        </div>
                        <div className="bg-green-900 px-1">
                            <h3 className="text-3xl text-center">PostgreSQL</h3>
                        </div>
                        <div className="bg-green-900 px-1">
                            <h3 className="text-3xl text-center">Cloudinary</h3>
                        </div>
                    </div>
