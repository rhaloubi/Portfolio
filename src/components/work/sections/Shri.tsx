        ...
        <div className="flex flex-col font-[SFCompactRounded] md:flex-row gap-8">
            <div className="flex-1 p-4 text-center">
                ...
                <p className="text-gray-100 mb-6 px-8 text-lg">
                    SHRI is a distributed marketplace built with a microservices architecture using Go, Next.js, and Neon PostgreSQL. 
                    It includes independent services for user management, product catalog, orders, and stores, all connected through an API Gateway with JWT authentication, rate limiting, and Kubernetes orchestration.
                </p>
                <Button 
                    ...
                    onClick={() => router.push('/projects/Shri')}
                >
                    Check Project
                </Button>
            </div>
                ...
                <div className="w-full md:w-[35vw]">
                    <div className="flex justify-center font-[TTTrailers] text-gray-300 items-center gap-4 my-4">
                        <div className="bg-green-900 px-1">
                            <h3 className="text-3xl text-center">Go</h3>
                        </div>
                        <div className="bg-green-900 px-1">
